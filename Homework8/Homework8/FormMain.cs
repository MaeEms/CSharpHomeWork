...
namespace Homework8
{
    public partial class FormMain : Form
    {
        ...
        public FormMain()
        {
            ...
            Order order = new Order(1, new Customer("1", "杨先生"), new List<OrderItem>());
            order.AddItem(new OrderItem(1, new Goods("1", "苹果", 100.0), 10));
            order.AddItem(new OrderItem(2, new Goods("3", "牛奶", 300.0), 10));
            order.AddItem(new OrderItem(3, new Goods("4", "面包", 200.0), 10));
            
            orderService.AddOrder(order);
            Order order2 = new Order(2, new Customer("2", "张先生"), new List<OrderItem>());
            order2.AddItem(new OrderItem(1, new Goods("2", "鸡蛋", 200.0), 10));
